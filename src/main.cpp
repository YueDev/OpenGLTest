...
int main() {
    ...
    unsigned char *imgData = stbi_load("../img/1.jpg", &width, &height, &channelNum, 0);
    ...
    imgData = stbi_load("../img/2.jpg", &width, &height, &channelNum, 0);
...
//
        ...
        glm::mat4 viewMatrix = glm::lookAt(glm::vec3(0.0f, 0.0f, cameraZ), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
void setRotate(float delta) {
    rotate += delta;
    rotate = fmin(60.0f, fmax(-60.0f, rotate));
}
